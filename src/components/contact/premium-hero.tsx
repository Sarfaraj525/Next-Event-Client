...
export default function PremiumHero() {
  ...
  return (
    ...
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-blue-900/20 to-indigo-900/30 z-1"></div>
        ...
        <div className="max-w-5xl mx-auto text-center">
            ...
            {isVisible && (
              <>
                <motion.h2 
                  ...
                  className="text-sm font-medium uppercase tracking-widest text-blue-200 mb-2"
                >
                ...
                >
                  Let&apos;s Start a <span className="text-gradient bg-gradient-to-r text-5xl from-cyan-400 via-blue-400 to-teal-400">Conversation</span>
                </motion.h1>
                <motion.p 
                  custom={2}
                  initial="hidden"
          ...
          >
            ...
            <Button 
              ...
              className="bg-white/10 backdrop-blur-sm text-white border-white/30 hover:bg-white/20 px-8 py-7 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center gap-2"
            >
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="backdrop-blur-md bg-white/5 border border-white/20 rounded-xl p-5 h-full flex flex-col items-center justify-center relative overflow-hidden">
                  <div className={`absolute -top-1 -bottom-1 left-0 right-0 bg-gradient-to-r ${stat.gradient} opacity-20 rounded-xl`}></div>
